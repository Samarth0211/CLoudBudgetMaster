    ...
    <>
      ...
      {!isOpen && (
        <button onClick={() => setIsOpen(true)}
          className="fixed bottom-6 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-xl border border-slate-700 bg-[#232F3E] text-[#FF9900] shadow-lg hover:bg-[#2b3a4d] transition-colors">
